...
export class CalculadoraComponent implements OnInit {
   ...
   * através do ngOnInit(quando o componente é criado) e através do botão 'C'.
   *
   * @return void
   */
  limpar(): void {
  ...
  concatenaNumero(numAtual: string, numConcat: string): string {
    ...
    // caso '.' digitado e já tenha um '.' apenas retorna
  ...
  /**
   * Efeuta p cálculo de uma operação
   *
   * @returns void
   */
  calcular(): number {
